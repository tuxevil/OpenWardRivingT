...
if command -v apk >/dev/null 2>&1; then
    ...
    apk add coreutils-base64 2>/dev/null || echo "[!] Optional coreutils-base64 unavailable; remote bundle SSID decode will not work."
    ...
    opkg install coreutils-base64 2>/dev/null || echo "[!] Optional coreutils-base64 unavailable; remote bundle SSID decode will not work."
else
...
chmod +x /usr/bin/wardriving_clients.sh
